...
`,[H(">",[u("clear",`
 ...
 `,[Sn({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),Rt=te({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(e){return Rn("-base-clear",Co,we(e,"clsPrefix")),{handleMouseDown(p){p.preventDefault()}}},render(){const{clsPrefix:e}=this;return o("div",{class:`${e}-base-clear`},o(Fn,null,{default:()=>{var p,b;return this.show?o("div",{key:"dismiss",class:`${e}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},Qe(this.$slots.icon,()=>[o(lt,{clsPrefix:e},{default:()=>o(yo,null)})])):o("div",{key:"icon",class:`${e}-base-clear__placeholder`},(b=(p=this.$slots).placeholder)===null||b===void 0?void 0:b.call(p))}}))}}),Wt=te({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(e,{slots:p}){return()=>{const{clsPrefix:b}=e;return o(Tn,{clsPrefix:b,class:`${b}-base-suffix`,strokeWidth:24,scale:.85,show:e.loading},{default:()=>e.showArrow?o(Rt,{clsPrefix:b,show:e.showClear,onClear:e.onClear},{placeholder:()=>o(lt,{clsPrefix:b,class:`${b}-base-suffix__arrow`},{default:()=>Qe(p.default,()=>[o(xo,null)])})}):null})}}}),_o=H([g("base-selection",`
 position: relative;
 z-index: auto;
 box-shadow: none;
 width: 100%;
